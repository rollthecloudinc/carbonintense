...
export const environment = {
  ...
  apiGatewaySettings: {
    ...
    endpointUrl: "https://vertigo.druidcloud.dev/rollthecloudinc/carbonintense-objects/shapeshifter"
  },
  mediaSettings: {
    endpointUrl: 'https://vertigo.druidcloud.dev/carbonintense/media',
    cloudinaryUrl: 'https://api.cloudinary.com/v1_1/dj4vvkgzw',
    uploadPreset: 'i0hm4opm',
    imageUrl: 'https://vertigo.druidcloud.dev/carbonintense',
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://carbonintense.druidcloud.dev/auth-callback',
    silent_redirect_uri: 'https://carbonintense.druidcloud.dev/silent-refresh.html',
    response_type: "code",
