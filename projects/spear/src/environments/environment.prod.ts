...
export const environment = {
  ...
  site: 'carbonintense',
  apiGatewaySettings: {
    endpointUrl: 'https://edge.hedge.earth/emissionless/rollthecloudinc/carbonintense-objects-prod/shapeshifter',
  },
  mediaSettings: {
    ...
    imageUrl: 'https://edge.hedge.earth/emissionless/carbonintense',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/carbonintense-objects-prod'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-prod-o5unofrr3c4qb3ykfrxebh2e4a'
  },
